...
export class BitrixService {
  ...
  private static readonly SALE_STAGE_IDS = new Set<string>([
    ...
    // Ждём вступительный взнос, Договор в работе
    'C48:UC_CONTRACT_DONE', 'C48:UC_FEE_PAID', 'C48:WON', 'C48:UC_FEE_WAIT', 'C48:UC_CONTRACT_PROC',
    // 2026-2027 Набор в 1 класс (52): Договор подписан, Сделка успешна, Вступительный взнос оплачен,
    // Договор в процессе, Ждём вступительный взнос
    'C52:UC_CONTRACT_DONE', 'C52:WON', 'C52:UC_FEE_PAID', 'C52:UC_CONTRACT_PROC', 'C52:UC_FEE_WAIT',
